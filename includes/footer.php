...
<h3>Steves's Shopping Portal</h3>
            </a>
        </div><!-- /.logo -->
        ...
        <ul class="toggle-footer" style="">
            <li class="media">
              ...
              <li class="media">
                ...
                <div class="media-body">
                    <p>(+254) 792 710 951<br>(+254) 101 323 120</p>
                </div>
            </li>
              ...
              <li class="media">
                ...
                <div class="media-body">
                    <span><a href="mailito:steveakoko@shoppingstore.com">steveakoko@shoppingstore.com</a></span>
                </div>
            </li>
